                                ...
                                <div class="col-md-5">
                                    <div class="gallery-content-info">
                                        <div class="editor-content">
                                            ...
                                            <p>A 60 year old female presents to her GP with fatigue, weight loss and wheeze.
                                                ...
                                                wheeze
                                                in the right upper zone. A chest X-ray is requested to assess for malignancy
                                                or
                                                COPD.</p>

                                            <p><strong>Patient ID:</strong> Anonymous <strong>Projection:</strong> PA</p>
                                            <p><strong>Penetration:</strong> Adequate – vertebral bodies just visible behind
                                                heart</p>
                                            <p><strong>Inspiration:</strong> Adequate – 7 anterior ribs visible</p>
                                            <p><strong>Rotation:</strong> The patient is slightly rotated to the right</p>

                                            <h2>AIRWAY</h2>
                                            <p>The trachea is central after factoring in patient rotation.</p>

                                            <h2>BREATHING</h2>
                                            <p>There is a right upper zone mass projected over the anterior aspects of the
                                                right
                                                1st and 2nd ribs. There are multiple small pulmonary nodules visible within
                                                the
                                                left hemithorax.</p>
                                            ...
                                            <p>The right hilum is abnormally dense. It also appears higher than the left.
                                                Normal
                                            ...
                                            <p>The imaged skeleton is intact with no fractures or destructive bony lesions
                                                visible.</p>
                                            ...
                                            <p>This X-ray demonstrates a large, rounded right upper lobe lung lesion
                                                associated
                                                with multiple smaller nodules. This is highly suspicious of a right upper
                                                lobe
                                            ...
                                            <p>The patient should be referred to respiratory/oncology services for further
                                                management, which may include biopsy and MDT discussion. Treatment, which
                                                may
                                                include surgery, radiotherapy, chemotherapy, or palliative treatment, will
