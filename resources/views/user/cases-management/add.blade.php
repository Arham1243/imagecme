                                                                ...
                                                                <div x-data="mcqManager()" class="form-fields">
                                                                    ...
                                                                    <div class="repeater-table">
                                                                        <table class="table table-bordered">
                                                                            ...
                                                                            <div class="pt-4"
                                                                                x-show="case_type === 'challenge_image_diagnosis'">
                                                                                <div x-data="mcqManager()"
                                                                                    class="form-fields">
                                                                                    <label
                                                                                        class="d-flex align-items-center mb-3 justify-content-between">
                                                                                        <span
                                                                                            class="title title--sm mb-0">MCQs
                                                                                            Image
                                                                                            Diagnosis</span>
                                                                                    </label>
                                                                                    <div class="repeater-table">
                                                                    ...
                                                                    <div x-data="imageTypeManager()">
                                                                        <div class="col-lg-12 mb-4">
                                                                            ...
                                                                            <template
                                                                                x-for="(type, index) in selectedTypes"
                                                                                :key="index">
                                                                    ...
                                                                    <div class="col-lg-12 mb-4"
                                                                        x-show="case_type !== 'challenge_image_diagnosis'">
                                                                        <div class="form-fields">
                                                                            <label class="title">Specific Diagnosis Title
                                                                                :</label>
                                                                            <input type="text"
                                                                    ...
                                                                    <div class="col-lg-6 mb-4">
                                                                        ...
                                                                        @endphp
                                                                        <div class="form-fields">
                                                                            <label class="title">Diagnosed Disease
                                                                                :</label>
                                                                    ...
                                                                    <div class="col-lg-6 mb-4">
                                                                        ...
                                                                        @endphp
                                                                        <div class="form-fields">
                                                                            <label class="title">Ease of Diagnosis
                                                                                :</label>
                                                                    ...
                                                                    <div class="col-lg-6 mb-2">
                                                                        <div class="form-fields">
                                                                            <label class="title">Clinical Examination
                                                                                :</label>
                                                                            <input type="text"
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-fields">
                                                                            <div class="title title--sm mb-2">Add
                                                                                Co-Author:</div>
                                                                            <div class="repeater-table"
                                                                                x-data="{
                                                                    ...
                                                                    <div class="col-lg-12 mb-2">
                                                                        <div class="form-fields">
                                                                            <div class="title title--sm">Patient info:
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6 mb-4">
                                            ...
                                            <div class="form-box__body">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="status"
                                                        id="active" checked value="active">
